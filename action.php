...
if(isset($_POST["brand"])){
	...
	echo "
		<div class='nav nav-pills nav-stacked'>
			<li class='active'><a href=''><h4>Sub Category</h4></a></li>
	";
	if(mysqli_num_rows($run_query) > 0){
		while($row = mysqli_fetch_array($run_query)){
			$bid = $row["brand_id"];
			...
			echo "
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-heading'>".CURRENCY."$pro_price (1$=Rs.76)
			...
			echo "
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-heading'>$ $pro_price (1$=Rs.76)
									<button pid='$pro_id' style='float:right;' id='product' class='btn btn-danger btn-xs'>Add To Cart</button>
								</div>
							</div>
						</div>	
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="https://www.sandbox.paypal.com/cgi-bin/webscr"
							...
							<input type="hidden" name="business" value="kirtanpatel@business.example.com">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/ecommerce-app-h/payment_success.php"/>
									...
									<input type="hidden" name="cancel_return" value="http://localhost/Ecommerce-app-h/cart.php"/>
